// eslint-disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2U1dWQmVnPT06ODcxMDFhMTg=
...
// NOTE  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2U1dWQmVnPT06ODcxMDFhMTg=
...
知识库增强：${enableRag ? "启用，请优先检索当前项目知识库" : "未启用"}

请根据以上需求生成测试用例，并保存到当前项目的测试用例库。`;
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="flex items-start gap-3 rounded-lg border p-3">
            ...
            <div className="grid gap-1">
              <Label htmlFor="enable-rag" className="cursor-pointer text-sm font-medium">
                启用知识库增强
              </Label>
              <p className="text-xs text-muted-foreground">
                使用当前项目的 LightRAG 知识库检索历史需求、规则和测试资产
              </p>
            </div>
          </div>
        </div>
...
// eslint-disable  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2U1dWQmVnPT06ODcxMDFhMTg=
