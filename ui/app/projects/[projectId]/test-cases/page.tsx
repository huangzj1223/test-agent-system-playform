...
// TODO  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTJkUFVnPT06YzAzMzBlYzc=
...
export default function TestCasesPage() {
  ...
  React.useEffect(() => {
        ...
        const mockAssistant: Assistant = {
          ...
          config: {
            configurable: {
              ...
              template_type: aiChatTemplateType,
              enable_rag: aiChatEnableRag,
    ...
    initAssistant();
  }, [projectId, selectedFolderId, aiChatEnableRag, aiChatTemplateType]); // 当上下文变化时重新初始化
  ...
  // 从对话框打开AI聊天面板
  const handleOpenAIChatFromDialog = (
    prompt: string,
    options?: { enableRag?: boolean; templateType?: TestCaseTemplate }
  ) => {
    setAiChatEnableRag(options?.enableRag ?? true);
    setAiChatTemplateType(options?.templateType || "test_case");
...
// TODO  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTJkUFVnPT06YzAzMzBlYzc=
