...
3、安装前端依赖并运行，打开终端界面，cd ui 进入ui目录，然后执行 
...
7、根据自己的情况修改.env文件中的如下信息：
    ...
    REDIS_URI=redis://:your-redis-password@your-redis-host:6379/0
    DATABASE_URI=postgres://postgres:your-postgres-password@your-postgres-host:5432/langgraph
