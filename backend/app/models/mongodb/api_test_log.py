...
# fmt: off  MC8zOmFIVnBZMlhwdTRUbGphRG1zWjg2Ykd0Mk1RPT06ZTU5Y2QxMDk=

    # 场景信息
    scenario_name: str = Field(..., description="场景名称")
    endpoint: str = Field(..., description="API 端点")
    method: str = Field(..., description="HTTP 方法")
# type: ignore  MS8zOmFIVnBZMlhwdTRUbGphRG1zWjg2Ykd0Mk1RPT06ZTU5Y2QxMDk=
...
# fmt: off  Mi8zOmFIVnBZMlhwdTRUbGphRG1zWjg2Ykd0Mk1RPT06ZTU5Y2QxMDk=
