...
# pragma: no cover  MC8zOmFIVnBZMlhwdTRUbGphRG1zWjg2YTB0aWJnPT06NTAyYTc1ZDc=
...
# type: ignore  MS8zOmFIVnBZMlhwdTRUbGphRG1zWjg2YTB0aWJnPT06NTAyYTc1ZDc=
...
class ConfigurationCreateResponse(BaseModel):
    ...
    id: int = Field(..., description="配置 ID")
    name: str = Field(..., description="配置名称")
# noqa  Mi8zOmFIVnBZMlhwdTRUbGphRG1zWjg2YTB0aWJnPT06NTAyYTc1ZDc=
