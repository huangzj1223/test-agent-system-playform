...
class AttachmentRepository:
    """附件数据仓储"""
# fmt: off  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1hreWVBPT06ZmIzYTAyYjM=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1hreWVBPT06ZmIzYTAyYjM=
    ...
    async def get_step_attachments(
        ...
        return grouped
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1hreWVBPT06ZmIzYTAyYjM=
    ...
    async def delete_by_entity(
        ...
        await self.session.flush()
        return result.rowcount
# pylint: disable  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1hreWVBPT06ZmIzYTAyYjM=
