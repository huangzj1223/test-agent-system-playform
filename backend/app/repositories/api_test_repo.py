...
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2WTNjMmRRPT06Y2Y4NmJiMWI=
...
class APITestRepository(BaseRepository[APITest]):
    ...
    async def get_by_project(
        ...
        return items, total
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2WTNjMmRRPT06Y2Y4NmJiMWI=
...
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2WTNjMmRRPT06Y2Y4NmJiMWI=
...
class APITestResultRepository(BaseRepository[APITestResult]):
    ...
    async def get_by_test_run(
        ...
        items = list(result.scalars().all())
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2WTNjMmRRPT06Y2Y4NmJiMWI=
