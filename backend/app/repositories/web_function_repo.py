...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTA5S1JRPT06NTNjMzJmNGQ=
...
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTA5S1JRPT06NTNjMzJmNGQ=
...
class WebSubFunctionRepository(BaseRepository[WebSubFunction]):
    ...
    async def get_by_id_with_relations(self, id: UUID) -> Optional[WebSubFunction]:
        ...
        return result.scalar_one_or_none()
# type: ignore  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTA5S1JRPT06NTNjMzJmNGQ=
    ...
    async def get_by_project(
        ...
        return items, total
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTA5S1JRPT06NTNjMzJmNGQ=
