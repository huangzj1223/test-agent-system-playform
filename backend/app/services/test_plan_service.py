...
# fmt: off  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkV0RGRnPT06YzhiNzY5ZmM=
...
class TestPlanService:
    ...
    async def get_test_plan(
        ...
        if not project:
            raise NotFoundException(resource_type="项目", resource_id=project_identifier)
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkV0RGRnPT06YzhiNzY5ZmM=
    ...
    async def update_test_plan(
        ...
        if not project:
            raise NotFoundException(resource_type="项目", resource_id=project_identifier)
# type: ignore  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkV0RGRnPT06YzhiNzY5ZmM=
...
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkV0RGRnPT06YzhiNzY5ZmM=
