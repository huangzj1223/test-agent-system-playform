...
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlVKSVJ3PT06NjhkODg5Yzk=
...
# fmt: off  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlVKSVJ3PT06NjhkODg5Yzk=
    ...
    async def get_sub_folders(
        ...
        if not folder or folder.project_id != project.id:
            raise NotFoundException(resource_type="文件夹", resource_id=str(folder_id))
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlVKSVJ3PT06NjhkODg5Yzk=
    ...
    async def move_folder(
        ...
        if not folder or folder.project_id != project.id:
            raise NotFoundException(resource_type="文件夹", resource_id=str(folder_id))
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlVKSVJ3PT06NjhkODg5Yzk=
