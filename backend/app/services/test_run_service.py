...
class TestRunService:
    ...
    async def _resolve_test_plan_id(
        ...
        return tp.id
# fmt: off  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2YWpOTmNRPT06NmEzOTQ3YTc=
...
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2YWpOTmNRPT06NmEzOTQ3YTc=
        ...
        if data.test_cases:
            ...
            for ident in data.test_cases:
                ...
                if tc and tc.project_id == project_id and tc.id not in seen:
                    ...
                    seen.add(tc.id)
            return resolved
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2YWpOTmNRPT06NmEzOTQ3YTc=
...
# pylint: disable  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2YWpOTmNRPT06NmEzOTQ3YTc=
