...
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUhSU1ZnPT06NTc1Y2IyOWI=
...
# fmt: off  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUhSU1ZnPT06NTc1Y2IyOWI=
...
class ScenarioExecutor(ScriptExecutor):
    ...
    async def execute(self, script_id: UUID, config: Dict[str, Any]) -> ExecutionResult:
        ...
        start_time = datetime.now(timezone.utc)
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUhSU1ZnPT06NTc1Y2IyOWI=
...
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUhSU1ZnPT06NTc1Y2IyOWI=
