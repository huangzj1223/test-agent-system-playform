...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2Tm1wYU5BPT06OGMyMDkyYjg=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2Tm1wYU5BPT06OGMyMDkyYjg=
    ...
    async def get_test_result_attachments(
        ...
        if not test_result:
            raise NotFoundException(resource_type="测试结果", resource_id=test_result_id)
# fmt: off  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2Tm1wYU5BPT06OGMyMDkyYjg=
...
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2Tm1wYU5BPT06OGMyMDkyYjg=
