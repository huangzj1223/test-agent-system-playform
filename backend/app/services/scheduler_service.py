...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkhKcllnPT06YzBjODg1NjA=
...
class TestRunSchedulerService:
    ...
    def remove_schedule(self, schedule_id: str) -> None:
        ...
        try:
            ...
            pass
# fmt: off  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkhKcllnPT06YzBjODg1NjA=
    ...
    async def _execute_scheduled_run(self, schedule_id: str) -> None:
        ...
        async with async_session_factory() as session:
            ...
            await session.flush()
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkhKcllnPT06YzBjODg1NjA=
...
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2WkhKcllnPT06YzBjODg1NjA=
