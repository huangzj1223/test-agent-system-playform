...
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1VZMlJ3PT06MGViYmM1Zjc=
...
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1VZMlJ3PT06MGViYmM1Zjc=
    ...
    async def delete_api_test(
        ...
        project = await self._get_project_by_identifier(project_identifier)
        api_test = await self.api_test_repo.get_by_id(UUID(api_test_id))
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1VZMlJ3PT06MGViYmM1Zjc=
    ...
    async def get_test_runs(
        ...
        if not api_test or api_test.project_id != project.id:
            raise NotFoundException(resource_type="API 测试", resource_id=api_test_id)
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2T1VZMlJ3PT06MGViYmM1Zjc=
