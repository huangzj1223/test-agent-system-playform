...
class CreateWebSubFunctionRequest(BaseModel):
    ...
    custom_config: Optional[dict] = None
    sort_order: int = 0
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZDJwRVJRPT06OTNlZGE5MWY=
...
# ============ Web 功能管理接口 ============
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZDJwRVJRPT06OTNlZGE5MWY=
...
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZDJwRVJRPT06OTNlZGE5MWY=
...
async def get_web_function(
    ...
    return SuccessResponse(data=result)
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZDJwRVJRPT06OTNlZGE5MWY=
