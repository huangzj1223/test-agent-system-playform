...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2UTJwTWNBPT06NGRlMDk3ZTM=
...
async def save_web_test_cases(
    ...
    async with async_session_factory() as session:
        ...
        sub_function_result = await session.execute(sub_function_stmt)
        sub_function = sub_function_result.scalar_one_or_none()
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2UTJwTWNBPT06NGRlMDk3ZTM=

        if not sub_function:
            return {"error": f"Sub-function {sub_function_id} not found"}
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2UTJwTWNBPT06NGRlMDk3ZTM=
...
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2UTJwTWNBPT06NGRlMDk3ZTM=
