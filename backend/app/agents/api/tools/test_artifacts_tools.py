...
def _resolve_workspace_path(file_path: str) -> Path:
    ...
    """
    path = Path(file_path)
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUVsMVZRPT06YTMyNjU4NTI=
...
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUVsMVZRPT06YTMyNjU4NTI=
...
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUVsMVZRPT06YTMyNjU4NTI=
...
async def save_test_script(
    ...
    async with async_session_factory() as session:
        ...
        existing_result = await session.execute(existing_stmt)
        existing_attachment = existing_result.scalar_one_or_none()
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUVsMVZRPT06YTMyNjU4NTI=
