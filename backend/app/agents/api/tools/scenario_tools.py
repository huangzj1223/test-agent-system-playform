...
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TW13M01RPT06ZGYzZTBkZGE=
            ...
            await session.commit()
            await session.refresh(scenario)
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TW13M01RPT06ZGYzZTBkZGE=
    ...
    async with async_session_factory() as session:
        try:
            ...
            if description is not None:
                ...
                updated_fields.append("description")
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TW13M01RPT06ZGYzZTBkZGE=
...
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TW13M01RPT06ZGYzZTBkZGE=
