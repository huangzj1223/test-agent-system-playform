// NOTE  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUdneFN3PT06ZDM2ODVmOWY=

import { test, expect } from '@playwright/test';
// NOTE  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUdneFN3PT06ZDM2ODVmOWY=

const BASE_URL = 'https://petstore.swagger.io/v2';
const API_KEY = 'special-key';
// TODO  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUdneFN3PT06ZDM2ODVmOWY=
...
// NOTE  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TUdneFN3PT06ZDM2ODVmOWY=
...
test.describe('DELETE /pet/{petId} - 删除宠物接口', () => {
  ...
  test.describe('❌ 负向测试', () => {
    test('TC-02: 使用无效 petId=0 删除宠物，预期返回 400', async ({ request }) => {
    ...
    test('TC-04: 使用字符串类型的 petId，预期返回 400', async ({ request }) => {
    ...
    test('TC-05: 使用负数 petId，预期返回 400', async ({ request }) => {
    ...
    test('TC-06: 不携带认证信息删除宠物', async ({ request }) => {
      ...
      // Petstore API 没有强制 OAuth 时可能返回不同状态码
      // 预期要么 200（接口允许），要么 401/403（权限校验）
