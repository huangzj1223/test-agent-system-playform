...
async def _recon_subdomains_impl(
    ...
    discovered = []
# noqa  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2UzBvMlF3PT06ZTAyNzgwNDI=
...
async def _recon_port_scan_impl(
    ...
    out_path = SECURITY_WORKSPACE / out_file
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2UzBvMlF3PT06ZTAyNzgwNDI=
...
async def _recon_directory_scan_impl(
    ...
    out_path = SECURITY_WORKSPACE / out_file
# fmt: off  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2UzBvMlF3PT06ZTAyNzgwNDI=
...
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2UzBvMlF3PT06ZTAyNzgwNDI=
