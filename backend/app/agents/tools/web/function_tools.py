...
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vm1KVFV3PT06MmI4NDgwNTk=
...
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vm1KVFV3PT06MmI4NDgwNTk=
...
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vm1KVFV3PT06MmI4NDgwNTk=
...
async def create_web_sub_function(
    ...
    async with async_session_factory() as session:
        ...
        if not project:
            return {"error": f"Project {project_identifier} not found"}
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vm1KVFV3PT06MmI4NDgwNTk=
