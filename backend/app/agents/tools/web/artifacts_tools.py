...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2Unpaa1lnPT06YWY1MjA1MWU=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2Unpaa1lnPT06YWY1MjA1MWU=
...
async def save_web_test_script(
    ...
    async with async_session_factory() as session:
        ...
        if not sub_function:
            return {"error": f"Sub-function {sub_function_id} not found"}
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2Unpaa1lnPT06YWY1MjA1MWU=
...
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2Unpaa1lnPT06YWY1MjA1MWU=
