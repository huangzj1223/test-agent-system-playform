...
# fmt: off  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2WmtOSGRnPT06MDc5Yzc1NDM=
...
def _flatten_steps(steps: list[dict[str, Any]] | None) -> str:
    ...
    for step in steps:
        ...
        lines.append(line)
    return "\n".join(lines)
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2WmtOSGRnPT06MDc5Yzc1NDM=
...
def _flatten_preconditions(preconditions: list[str] | str | None) -> str:
    ...
    return "\n".join(lines)
# type: ignore  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2WmtOSGRnPT06MDc5Yzc1NDM=
...
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2WmtOSGRnPT06MDc5Yzc1NDM=
