...
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFvNFJRPT06Y2MxYjk4MzY=
...
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFvNFJRPT06Y2MxYjk4MzY=
            ...
            scenario.updated_at = datetime.now(timezone.utc)
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFvNFJRPT06Y2MxYjk4MzY=
...
async def add_data_mapping(
    ...
    async with async_session_factory() as session:
        try:
            ...
            step_result = await session.execute(step_stmt)
            step = step_result.scalar_one_or_none()
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFvNFJRPT06Y2MxYjk4MzY=
