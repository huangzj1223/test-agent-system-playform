...
def _resolve_workspace_path(file_path: str) -> Path:
    ...
    """
    path = Path(file_path)
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2Y0hOWVlRPT06OWNkZDIwMjk=
...
# noqa  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2Y0hOWVlRPT06OWNkZDIwMjk=
...
async def save_test_script(
    ...
    try:
        ...
        return {"error": f"Invalid endpoint_id format: {endpoint_id}. Must be a valid UUID."}
# pylint: disable  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2Y0hOWVlRPT06OWNkZDIwMjk=
...
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2Y0hOWVlRPT06OWNkZDIwMjk=
