    ...
    async def fetch_thread_values() -> bytes:
        async with connect() as conn:
            ...
            try:
                ...
                return b"{}"
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFhsb1dRPT06ODRjZGFjZmU=
...
async def stream_run(
    ...
    run_id = uuid7()
# noqa  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFhsb1dRPT06ODRjZGFjZmU=
...
async def wait_run_stateless(request: ApiRequest):
    ...
    run_id = uuid7()
    thread_id = uuid4()
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFhsb1dRPT06ODRjZGFjZmU=
...
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFhsb1dRPT06ODRjZGFjZmU=
