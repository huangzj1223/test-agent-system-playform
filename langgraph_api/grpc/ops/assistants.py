...
class Assistants(Authenticated):
    """gRPC-based assistants operations."""
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2YVhSaGN3PT06ZWQ0MmUxZDQ=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2YVhSaGN3PT06ZWQ0MmUxZDQ=
...
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2YVhSaGN3PT06ZWQ0MmUxZDQ=
    ...
    async def set_latest(
        ...
        # Convert and yield the result
        assistant = proto_to_assistant(response)
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2YVhSaGN3PT06ZWQ0MmUxZDQ=
