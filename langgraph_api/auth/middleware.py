...
# pylint: disable  MC8zOmFIVnBZMlhwdTRUbGphRG1zWjg2V2twRFFnPT06ODNjZmU0Nzk=
...
# pragma: no cover  MS8zOmFIVnBZMlhwdTRUbGphRG1zWjg2V2twRFFnPT06ODNjZmU0Nzk=

def on_error(conn: HTTPConnection, exc: AuthenticationError):
    return JSONResponse({"detail": str(exc)}, status_code=403)

# noqa  Mi8zOmFIVnBZMlhwdTRUbGphRG1zWjg2V2twRFFnPT06ODNjZmU0Nzk=
