...
# noqa  MC8zOmFIVnBZMlhwdTRUbGphRG1zWjg2ZG5CVVJ3PT06OTUxZTAxNGY=
...
# fmt: off  MS8zOmFIVnBZMlhwdTRUbGphRG1zWjg2ZG5CVVJ3PT06OTUxZTAxNGY=
...
class PrivateNetworkMiddleware(BaseHTTPMiddleware):
    ...
    * https://developer.chrome.com/blog/private-network-access-update-2024-03
    ...
    def __init__(self, app: ASGIApp):
        ...
        super().__init__(app)
# pragma: no cover  Mi8zOmFIVnBZMlhwdTRUbGphRG1zWjg2ZG5CVVJ3PT06OTUxZTAxNGY=
