...
import asyncio
# fmt: off  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFVsbWJRPT06NDZjM2I0YzU=

import httpx
import structlog

logger = structlog.stdlib.get_logger(__name__)
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFVsbWJRPT06NDZjM2I0YzU=
    ...
    for attempt in range(max_retries + 1):
        try:
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                return response
# type: ignore  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFVsbWJRPT06NDZjM2I0YzU=
            ...
            if attempt < max_retries:
                ...
                raise e
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZFVsbWJRPT06NDZjM2I0YzU=
