...
# pragma: no cover  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VVRBNU5nPT06MGM4ZDA2MTM=
...
class StreamCodec:
    ...
    def encode(
        ...
        *,
        ...
        return bytes(frame)
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VVRBNU5nPT06MGM4ZDA2MTM=
...
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VVRBNU5nPT06MGM4ZDA2MTM=
...
def _find_delim(view: memoryview, start: int, delimiter: bytes) -> int:
    ...
    while i <= end:
        ...
        i += 1
    return -1
# type: ignore  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VVRBNU5nPT06MGM4ZDA2MTM=
