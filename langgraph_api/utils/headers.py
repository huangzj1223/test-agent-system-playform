...
def translate_pattern(pat: str) -> re.Pattern[str]:
    ...
    while i < n:
        c = pat[i]
        i += 1
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2WlVwQk1BPT06YmUzMjE3ZWY=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2WlVwQk1BPT06YmUzMjE3ZWY=
...
# fmt: off  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2WlVwQk1BPT06YmUzMjE3ZWY=
...
def pattern_matches(
    ...
    return False
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2WlVwQk1BPT06YmUzMjE3ZWY=
