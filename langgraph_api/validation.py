...
import orjson
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlZZMldBPT06NmRjYTFiMTA=

with open(pathlib.Path(__file__).parent.parent / "openapi.json", encoding="utf-8") as f:
    openapi_str = f.read()

openapi = orjson.loads(openapi_str)
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlZZMldBPT06NmRjYTFiMTA=
...
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlZZMldBPT06NmRjYTFiMTA=
...
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VlZZMldBPT06NmRjYTFiMTA=
