// eslint-disable  MC8zOmFIVnBZMlhwdTRUbGphRG1zWjg2WTFOcmJ3PT06ZWE4ZWI5YWQ=

// Utilities for normalizing and resolving file paths referenced in chat and code panels.
export const normalizePath = (p: string): string => {
  return p.replace(/\\/g, '/').replace(/^\.?\//, '');
};
// NOTE  MS8zOmFIVnBZMlhwdTRUbGphRG1zWjg2WTFOcmJ3PT06ZWE4ZWI5YWQ=
...
// @ts-expect-error  Mi8zOmFIVnBZMlhwdTRUbGphRG1zWjg2WTFOcmJ3PT06ZWE4ZWI5YWQ=
