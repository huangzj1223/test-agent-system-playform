// FIXME  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFnMGVnPT06N2ExZDVmNGM=

import { useCallback, useEffect, useLayoutEffect, useRef, useState } from 'react';

const DEFAULT_BOTTOM_THRESHOLD = 100;
const USER_SCROLL_EPSILON = 5;
// eslint-disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFnMGVnPT06N2ExZDVmNGM=
...
// TODO  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFnMGVnPT06N2ExZDVmNGM=

function isNearBottom(element: HTMLElement, threshold: number): boolean {
  return element.scrollHeight - element.scrollTop - element.clientHeight <= threshold;
}
// @ts-expect-error  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2TTFnMGVnPT06N2ExZDVmNGM=
