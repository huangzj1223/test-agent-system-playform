...
class QueryBuilder:
    ...
    def where_in(self, column: str, values: List[Any]) -> 'QueryBuilder':
        ...
        if not values:
            return self
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VEhGWmRRPT06NDFmNWU1ZjE=
    ...
    def build(self) -> Tuple[str, List]:
        ...
        for join in self._joins:
            query += f"{join}\n"
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VEhGWmRRPT06NDFmNWU1ZjE=
...
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VEhGWmRRPT06NDFmNWU1ZjE=
...
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VEhGWmRRPT06NDFmNWU1ZjE=
