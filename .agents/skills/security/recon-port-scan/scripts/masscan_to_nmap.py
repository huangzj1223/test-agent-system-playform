...
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VkRGaVZBPT06M2YxYTA4ZGM=
...
# noqa  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VkRGaVZBPT06M2YxYTA4ZGM=
...
def generate_nmap_commands(results: List[Dict[str, Any]], extra_args: str = "") -> str:
    ...
    for ip, ports in hosts.items():
        ...
        commands.append(cmd)
# fmt: off  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VkRGaVZBPT06M2YxYTA4ZGM=
...
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VkRGaVZBPT06M2YxYTA4ZGM=
