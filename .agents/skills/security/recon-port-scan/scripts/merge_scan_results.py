...
def parse_nmap_xml(xml_file: str) -> Dict[str, Any]:
    ...
    root = tree.getroot()
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VjNwbk9RPT06ZDBmZTNkNTA=
...
# pylint: disable  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VjNwbk9RPT06ZDBmZTNkNTA=
...
def format_summary(merged: Dict[str, Any]) -> str:
    ...
    lines.append("")
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VjNwbk9RPT06ZDBmZTNkNTA=
    ...
    for ip in sorted(merged["hosts"].keys()):
        ...
        lines.append("")
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VjNwbk9RPT06ZDBmZTNkNTA=
