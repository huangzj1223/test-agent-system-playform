...
subfinder -d example.com | python .Codex/skills/recon-subdomain/scripts/subdomain_storage.py
...
python .Codex/skills/recon-subdomain/scripts/subdomain_storage.py \
