...
# type: ignore  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUZSU09BPT06Y2E3NGMwZTc=
...
def get_subdomain_word(subdomain: str) -> str:
    ...
    if len(parts) >= 3:
        return parts[0]
    return ''
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUZSU09BPT06Y2E3NGMwZTc=
...
# type: ignore  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUZSU09BPT06Y2E3NGMwZTc=
    ...
    if args.json:
        ...
        for word, count in stats['common_words'].most_common(args.top_n):
            print(f"  {word}: {count}")
# noqa  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2ZUZSU09BPT06Y2E3NGMwZTc=
