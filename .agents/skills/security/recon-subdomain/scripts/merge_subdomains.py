...
def read_subdomains(file_path: str) -> Set[str]:
    ...
    return subdomains
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2YnpkQlpnPT06NmRmZjZkMDQ=
...
# type: ignore  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2YnpkQlpnPT06NmRmZjZkMDQ=
...
# fmt: off  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2YnpkQlpnPT06NmRmZjZkMDQ=
    ...
    with open(args.output, 'w') as f:
        for sub in output:
            f.write(f"{sub}\n")
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2YnpkQlpnPT06NmRmZjZkMDQ=
