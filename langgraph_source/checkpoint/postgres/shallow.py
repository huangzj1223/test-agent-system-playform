...
from checkpoints """
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2VUdsWlNnPT06NTk4MTQ5MGI=
...
class ShallowPostgresSaver(BasePostgresSaver):
    ...
    def put(
        ...
        return next_config
# fmt: off  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2VUdsWlNnPT06NTk4MTQ5MGI=
...
class AsyncShallowPostgresSaver(BasePostgresSaver):
    ...
    def __init__(
        ...
        self.supports_pipeline = Capabilities().has_pipeline()
# pragma: no cover  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2VUdsWlNnPT06NTk4MTQ5MGI=
...
# fmt: off  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2VUdsWlNnPT06NTk4MTQ5MGI=
