...
# pylint: disable  MC80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vlc1S1NRPT06MjYxOTA1NDQ=
...
# pragma: no cover  MS80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vlc1S1NRPT06MjYxOTA1NDQ=
...
# noqa  Mi80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vlc1S1NRPT06MjYxOTA1NDQ=
    ...
    def _cursor(self, *, pipeline: bool = False) -> Iterator[Cursor[DictRow]]:
        ...
        with self.lock, _internal.get_connection(self.conn) as conn:
            if self.pipe:
                ...
                with conn.cursor(binary=True, row_factory=dict_row) as cur:
                    yield cur
# pragma: no cover  My80OmFIVnBZMlhwdTRUbGphRG1zWjg2Vlc1S1NRPT06MjYxOTA1NDQ=
